...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file, String candidateId) throws FileStorageException {
        ...
        try {
            Path resourceDirectory = Paths.get("tomek","src", "main", "resources", "files_uploaded").toAbsolutePath();
    ...
    public Resource loadFileAsResource(String fileName) {
        try {
            //src/main/resources/files_uploaded/test.pdf
            Path filePath = Paths.get("tomek", "src", "main", "resources", "files_uploaded").resolve(fileName).normalize();
